...
exec singularity exec --nv $DEEPSPEED_IMAGE /nfshome/store03/users/c.scmse/venv/bin/python3 -m torch.distributed.launch --nnodes 1 --nproc-per-node 2 funtuner/trainer.py
